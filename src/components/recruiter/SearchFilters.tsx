...
export default function SearchFilters({ onFilterChange, searchTerm, onSearchChange }: SearchFiltersProps) {
    ...
    return (
        <aside className="w-full md:w-80 space-y-4 lg:sticky lg:top-24 h-fit">
            {/* Filters Header */}
            ...
            <div className="space-y-4">
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-5">
                    {/* Verified Only */}
                    <label className="flex items-center justify-between p-2.5 bg-blue-50/30 rounded-lg border border-blue-100 cursor-pointer group transition-colors hover:bg-blue-50">
                        <div className="flex items-center gap-2">
                            <CheckCircle2 className="w-3.5 h-3.5 text-blue-600" />
                            <span className="text-[12px] font-semibold text-blue-900">Verified Candidates</span>
                        </div>
                        <input
                            type="checkbox"
                    ...
                    <div className="space-y-2">
                        ...
                        <select
                            ...
                            className="w-full px-3 py-2 bg-slate-50 border border-slate-100 rounded-lg text-[13px] font-semibold outline-none text-slate-700 focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all cursor-pointer"
                        >
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            placeholder="e.g. AWS, PSIRA"
                            className="w-full px-3 py-2 bg-slate-50 border border-slate-100 rounded-lg text-[13px] font-semibold outline-none text-slate-700 focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all"
                        />
                    </div>
                    ...
                    <div className="space-y-2 pt-4 border-t border-slate-100">
                        <div className="flex items-center justify-between group">
                            <span className="text-[13px] font-semibold text-slate-600 transition-colors group-hover:text-blue-600">Driver's License</span>
                            <input
                                type="checkbox"
                        ...
                        <div className="flex items-center justify-between group">
                            <span className="text-[13px] font-semibold text-slate-600 transition-colors group-hover:text-blue-600">Own Transport</span>
                            <input
                                type="checkbox"
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-3 shadow-sm">
                    <button
                        ...
                        className={`w-full py-2.5 px-3 rounded-lg flex items-center justify-between transition-all ${showAdvancedSkills ? 'bg-slate-900 text-white shadow-lg shadow-slate-200' : 'bg-slate-50 text-slate-700 hover:bg-slate-100'}`}
                    >
                        <span className="text-[10px] font-bold uppercase tracking-wider">Advanced Skills</span>
                        {showAdvancedSkills ? <X className="w-3.5 h-3.5" /> : <Plus className="w-3.5 h-3.5" />}
                    </button>
