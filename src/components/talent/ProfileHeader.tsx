                    ...
                    <div className="flex-1 pt-4">
                        ...
                        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mt-3 md:mt-4">
                            ...
                            {email && (
                                <a
                                    href={`mailto:${email}`}
                                    className="flex items-center gap-2 text-[11px] text-black font-bold hover:text-blue-600 transition-colors group"
                                    title="Send email"
                                >
                            ...
                            {phone && (
                                <>
                                    ...
                                    <a
                                        ...
                                        className="flex items-center gap-1.5 px-2.5 py-1 bg-green-50 text-green-700 text-[10px] font-black uppercase tracking-wider rounded-lg border border-green-200 hover:bg-green-100 hover:border-green-300 transition-all shadow-sm group"
