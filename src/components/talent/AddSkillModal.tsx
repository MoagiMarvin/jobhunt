...
export default function AddSkillModal({ isOpen, initialMode = "technical", onClose, onAdd, initialData }: AddSkillModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm p-0 sm:p-4">
            <div className="bg-white rounded-t-3xl sm:rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden animate-in slide-in-from-bottom sm:zoom-in duration-300 max-h-[95vh] sm:max-h-[90vh] flex flex-col">
                {/* Mobile Grab Handle */}
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            className="flex-1 px-4 py-3 rounded-xl border-2 border-slate-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all font-medium text-sm"
                                        />
                                        <input
                                            type="number"
                                            ...
                                            onKeyPress={(e) => e.key === 'Enter' && addSkillToTempList()}
                                            placeholder="Yrs"
                                            className="w-20 px-4 py-3 rounded-xl border-2 border-slate-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all font-medium text-sm"
                                        />
                                        <button
